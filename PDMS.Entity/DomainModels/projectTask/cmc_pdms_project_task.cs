...
{
    [Entity(TableCnName = "專案工作計劃",TableName = "cmc_pdms_project_task",DBServer = "SysDbContext")]
    public partial class cmc_pdms_project_task:SysEntity
    {
        /// <summary>
       ///PK
       /// </summary>
