<template>
  ...
  <div class="project-name">vol.pro開發框架企業版本(1.0)</div>
    <div v-if="$global.db" class="app-lang">
    ...
    <div class="login-form">
      ...
      <div class="loging-btn">
        ...
        <p>演示賬號：admin666 &nbsp; &nbsp;密碼:123456</p>
        <p>本地賬號：admin &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;密碼:123456</p>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const login = () => {
      if (!userInfo.userName) return $message.error($ts(['請輸入', '賬號']));
