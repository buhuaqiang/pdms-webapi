...
<script>
    import extend from "@/extension/dbtest/order/Doc_Order1.js";
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([
                [{"title":"訂單編號","required":true,"field":"OrderNo","disabled":true},
            ...
            const columns = ref([{field:'Order_Id',title:'Order_Id',type:'guid',width:110,hidden:true,require:true,align:'left'},
                       {field:'OrderNo',title:'訂單編號',type:'string',link:true,width:140,require:true,align:'left',sort:true},
                       ...
                       {field:'Customer',title:'客戶',type:'string',width:90,align:'left'},
                       {field:'PhoneNo',title:'手機',type:'string',width:110,align:'left'},
