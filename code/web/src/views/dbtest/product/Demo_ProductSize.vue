 ...
 *業務請在@/extension/system/product/Demo_ProductSize.js此處編寫
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    import extend from "@/extension/dbtest/product/Demo_ProductSize.js";
    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'ProductSizeId',title:'ProductSizeId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'Remark',title:'備注',type:'string',link:true,width:120,align:'left'},
