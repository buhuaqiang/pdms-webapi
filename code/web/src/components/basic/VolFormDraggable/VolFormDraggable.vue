  ...
  <div class="drag-container">
    ...
    <div class="drag-center">
      <div class="center-top">
        ...
        <a
          ...
          target="_blank"
          >設計器基于框架volform、voltable、volupload、volbox定制開發</a
        >
      </div>
      <div>
        <el-alert
        ...
        >
          <div>
            1、表單設計器基于draggable開發,為本框架自定義頁面功能的補充,框架仍以可視化代碼生成器為核心
          </div>
          <div>
    ...
    <div class="drag-right">
      ...
      <div class="attr" v-show="currentIndex != -1">
        ...
        >
          <div class="text">上傳接口地址(后臺接口)</div>
          <el-input
            size="medium"
