    ...
    public partial class Sys_DictionaryService
    {
        ...
        public object GetVueDictionary(string[] dicNos)
        {
            ...
            object GetSourceData(string dicNo, string dbSql, object data,string DBServer)
            {
                ...
                return DBServerProvider.GetSqlDapperWidthDbService(DBServer).QueryList<object>(dbSql, null);
            }
        ...
        public List<DictionaryInfo> GetDictionaryData(int dic_id=-1, string dic_no = "")
        {
            ...
            if (deful != null && dic_id!=-1)
            {
                ...
                else
                {
                    ...
                    List<DictionaryInfo> TempList = JsonConvert.DeserializeObject<List<DictionaryInfo>>(list.Select(x => new { key = x.DicName, value = x.DicValue }).ToString());
                    return TempList;
                }
            }
